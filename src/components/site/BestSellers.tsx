  ...
  return (
    <section className="py-[60px] bg-surface">
      <div className="mx-auto max-w-7xl px-6">
        <div className="flex items-end justify-between flex-wrap gap-4 mb-8 sm:mb-14">
          <div>
            <span className="text-xs uppercase tracking-[0.25em] text-[oklch(0.50_0.14_232)] font-semibold">Best Sellers</span>
            <h2 className="mt-2 text-2xl sm:text-3xl lg:text-[40px] font-extrabold tracking-tight">Pro Favorites This Season.</h2>
          </div>
        </div>
