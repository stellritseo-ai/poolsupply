...
const items = [
  { name: "Marcus Reilly", role: "Owner, BlueWave Pools", quote: "AquaPro has been our go-to wholesaler for five years. The pricing, expertise, and shipping speed are unmatched in the industry." },
        ...
        <div className="grid md:grid-cols-3 gap-5">
          {items.map((t, i) => (
            <motion.figure
              ...
              className="p-7 rounded-3xl bg-surface border border-border hover:shadow-[var(--shadow-soft)] transition"
            >
