...
export const Route = createFileRoute("/guides/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Read our comprehensive pool equipment buying guides. Learn how to size pumps, heaters, and filters for your commercial or residential pool." },
      { name: "keywords", content: "pool equipment buying guide, pool pump sizing, pool heater sizing, pool filter comparison, pool automation guide" },
      { property: "og:title", content: "Pool Equipment Buying Guides" },
      { property: "og:description", content: "Expert guides for sizing and selecting commercial and residential pool equipment." },
      ...
      <main className="flex-1 pb-24">
        ...
        <div className="bg-slate-900 py-20 text-white relative overflow-hidden">
          ...
          <div className="container relative mx-auto px-4 text-center max-w-4xl">
            <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight mb-6">Expert Buying Guides</h1>
            <p className="text-lg md:text-xl text-slate-300 max-w-2xl mx-auto leading-relaxed">
              Make informed decisions. Learn how to properly size, select, and maintain your pool equipment.
            </p>
          </div>
        </div>
