  ...
  head: ({ loaderData }) => {
    ...
    const breadcrumbLd = {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 2, "name": "Guides", "item": "https://poolsupplywholesalers.com/guides" },
    ...
    <div className="flex min-h-screen flex-col bg-white">
      ...
      <div className="bg-slate-50 border-b border-slate-200 py-4">
        <div className="container mx-auto px-4 max-w-4xl">
          <nav className="flex items-center text-sm font-medium text-slate-500">
            ...
            <Link to="/guides" className="hover:text-cyan-600 transition-colors">Guides</Link>
            <ChevronRight className="size-4 mx-2 text-slate-400" />
      ...
      <main className="flex-1 py-12">
        <article className="container mx-auto px-4 max-w-4xl">
          ...
          <Link to="/guides" className="inline-flex items-center text-sm font-bold text-cyan-600 hover:text-cyan-700 mb-8 transition-colors">
          ...
          <div className="mt-16 bg-slate-50 rounded-2xl p-8 border border-slate-200 text-center">
            <h3 className="text-2xl font-bold text-slate-900 mb-4">Ready to find your equipment?</h3>
            <p className="text-slate-600 mb-6">Browse our complete wholesale catalog of {guide.category.toLowerCase()}.</p>
            <Link 
