  ...
  return (
    <div className="space-y-7 max-w-[1360px] mx-auto">
      ...
      <motion.div
        ...
        className="relative rounded-[32px] overflow-hidden p-8 sm:p-10 border border-cyan-500/20 bg-gradient-to-r from-[#020b18] via-[#05182e] to-[#040f1d] text-white shadow-2xl"
      >
        ...
        <div className="relative z-10 space-y-2.5">
          {/* Badge */}
          <div className="inline-flex items-center gap-1.5 px-3.5 py-1 rounded-full bg-cyan-950/60 border border-cyan-500/40 text-cyan-400 text-[10px] font-black tracking-widest uppercase shadow-inner">
            <Sparkles className="size-3 text-cyan-400" />
            <span>Live Database Telemetry Control Panel</span>
          </div>

          {/* Heading on Same Line & Clean Sizing */}
          <h1 className="text-2xl sm:text-3xl lg:text-[32px] font-black text-white tracking-tight leading-tight flex items-center gap-2 flex-wrap">
          ...
          <div className="flex items-center gap-2.5 flex-wrap pt-1 pb-1">
            <button
              onClick={refetchAll}
              className="size-10 rounded-full bg-white/10 hover:bg-white/20 border border-white/15 text-cyan-400 grid place-items-center backdrop-blur-md transition-all cursor-pointer shadow-md"
              title="Refresh Database Telemetry"
            >
              <RefreshCw className={`size-4 text-cyan-400 ${isLoading || quickLoading ? "animate-spin" : ""}`} />
            </button>

            <Link
              to="/admin/emails"
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full font-black text-xs text-slate-900 bg-white hover:bg-slate-100 transition-all shadow-lg cursor-pointer"
            >
              <Mail className="size-3.5 text-cyan-700" />
              <span>Inbox</span>
              {m.unreadEmails > 0 && (
                <span className="size-4.5 rounded-full bg-rose-500 text-white text-[9px] font-black grid place-items-center ml-0.5">
                  {m.unreadEmails}
                </span>
              )}
            </Link>
            ...
            <Link
              to="/admin/chat"
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full font-black text-xs text-white bg-white/10 hover:bg-white/15 border border-white/15 backdrop-blur-md transition-all shadow-md cursor-pointer"
            >
            ...
            <Link
              to="/admin/orders"
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full font-black text-xs text-white bg-[#00B4D8] hover:bg-[#0096C7] transition-all shadow-lg shadow-cyan-500/20 cursor-pointer"
            >
            ...
            <Link
              to="/admin/returns"
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full font-black text-xs text-slate-950 bg-[#F59E0B] hover:bg-[#D97706] transition-all shadow-lg shadow-amber-500/30 cursor-pointer"
            >
              <RotateCcw className="size-3.5 text-slate-950" />
              <span>Returns & RMA</span>
              <span className="size-5 rounded-full bg-slate-950 text-white text-[10px] font-black grid place-items-center ml-0.5">
            ...
            <Link
              to="/admin/quotes"
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full font-black text-xs text-white bg-gradient-to-r from-[#3B82F6] to-[#8B5CF6] hover:from-[#2563EB] hover:to-[#7C3AED] transition-all shadow-lg shadow-blue-500/30 cursor-pointer"
            >
              <FileText className="size-3.5 text-white" />
              <span>Quotes & Bids</span>
              <span className="size-5 rounded-full bg-[#00F0FF] text-slate-950 text-[10px] font-black grid place-items-center ml-0.5">
                {quotesList.length || 1}
              </span>
            </Link>
          </div>
      ...
      >
        ...
        <motion.div
          ...
          className="bg-white border border-slate-200/90 rounded-2xl p-5 shadow-2xs hover:border-cyan-500/30 hover:shadow-md transition-all group"
        >
          <div className="flex items-center justify-between mb-3">
            <span className="text-[10px] font-black uppercase tracking-wider text-slate-400">Total Revenue</span>
            <div className="size-9 rounded-xl bg-cyan-50 text-cyan-700 grid place-items-center group-hover:scale-110 transition-transform">
          ...
          <div className="mt-2 flex items-center gap-1.5 text-xs">
            {qs.revenueMoMChange !== 0 ? (
              <span className="inline-flex items-center gap-1 font-extrabold text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded-md text-[11px]">
        ...
        <motion.div
          variants={cardVariants}
          className="bg-gradient-to-br from-[#061220] to-[#091f38] border border-cyan-500/20 rounded-2xl p-5 text-white shadow-md hover:shadow-lg transition-all group"
        >
          <div className="flex items-center justify-between mb-3">
            <span className="text-[10px] font-black uppercase tracking-wider text-cyan-400">Customer Orders</span>
            <div className="size-9 rounded-xl bg-cyan-500/20 text-cyan-300 grid place-items-center group-hover:scale-110 transition-transform">
          ...
          <div className="mt-2 flex items-center gap-1.5 text-[11px] font-extrabold text-cyan-300">
        ...
        >
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="size-9 rounded-xl bg-indigo-50 text-indigo-700 grid place-items-center group-hover:scale-110 transition-transform">
          ...
          <div className="mt-2 flex items-center gap-1.5 text-[11px] text-slate-400 font-bold">
        ...
        >
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="size-9 rounded-xl bg-emerald-50 text-emerald-700 grid place-items-center group-hover:scale-110 transition-transform">
          ...
          <div className="mt-2 flex items-center gap-1.5 text-[11px] text-emerald-700 font-extrabold">
        ...
        <motion.div
          variants={cardVariants}
          className="col-span-2 md:col-span-1 bg-white border border-slate-200/90 rounded-2xl p-5 shadow-2xs hover:border-cyan-500/30 hover:shadow-md transition-all group"
        >
          <div className="flex items-center justify-between mb-3">
            <span className="text-[10px] font-black uppercase tracking-wider text-slate-400">Website Traffic</span>
            <div className="size-9 rounded-xl bg-amber-50 text-amber-700 grid place-items-center group-hover:scale-110 transition-transform">
          ...
          <div className="mt-2 flex items-center gap-1.5 text-[11px] text-amber-700 font-extrabold">
      ...
      <div className="grid lg:grid-cols-12 gap-6 items-start">
        ...
        <div className="lg:col-span-8 space-y-6">
          ...
          <div className="bg-white border border-slate-200/90 rounded-3xl p-6 sm:p-7 shadow-2xs space-y-5">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div>
                <h3 className="text-base sm:text-lg font-black text-slate-900 tracking-tight flex items-center gap-2">
                  ...
                  <span className="inline-flex items-center gap-1 text-[10px] font-extrabold text-cyan-800 bg-cyan-100/80 px-2.5 py-0.5 rounded-full">
              ...
              <div className="flex items-center gap-1.5 bg-slate-100/80 p-1 rounded-2xl border border-slate-200/70 shrink-0 self-start sm:self-auto">
                {(["7D", "30D", "6M", "12M"] as const).map((tf) => (
                  <button
                    key={tf}
                    onClick={() => setChartTimeframe(tf)}
                    className={`px-3 py-1 rounded-xl text-xs font-black transition-all cursor-pointer ${chartTimeframe === tf
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 p-3 rounded-2xl bg-slate-50/80 border border-slate-100 text-xs">
              <div>
                <div className="text-[10px] font-extrabold uppercase tracking-wider text-slate-400">Period Revenue</div>
                <div className="text-sm font-black text-slate-900 mt-0.5">{formatUSD(chartSummary.totalRev)}</div>
              </div>
              <div>
                <div className="text-[10px] font-extrabold uppercase tracking-wider text-slate-400">Orders Logged</div>
                <div className="text-sm font-black text-slate-900 mt-0.5">{chartSummary.totalOrders} Units</div>
              </div>
              <div>
                <div className="text-[10px] font-extrabold uppercase tracking-wider text-slate-400">Peak Spike</div>
                <div className="text-sm font-black text-cyan-700 mt-0.5">{formatUSD(chartSummary.maxRev)}</div>
              </div>
              <div>
                <div className="text-[10px] font-extrabold uppercase tracking-wider text-slate-400">Avg Ticket</div>
                <div className="text-sm font-black text-emerald-700 mt-0.5">{formatUSD(chartSummary.avgOrder)}</div>
              </div>
            </div>
            ...
            <div className="h-[300px] w-full pt-1">
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={dynamicChartData} margin={{ top: 15, right: 15, left: -15, bottom: 5 }}>
                  <defs>
                  ...
                  <Tooltip
                    content={({ active, payload, label }) => {
                      if (active && payload && payload.length) {
                        ...
                        return (
                          <div className="bg-[#020b18]/95 backdrop-blur-md text-white p-3.5 rounded-2xl shadow-2xl border border-cyan-500/30 text-xs space-y-1.5 min-w-[160px]">
                  ...
                  <Area
                    ...
                    dot={{ r: 3.5, fill: "#00B4D8", stroke: "#ffffff", strokeWidth: 2 }}
                    activeDot={{ r: 6, fill: "#00F0FF", stroke: "#020b18", strokeWidth: 2.5 }}
                  />
                </AreaChart>
              </ResponsiveContainer>
            </div>
          ...
          <div className="bg-white border border-slate-200/90 rounded-3xl p-6 sm:p-7 shadow-2xs space-y-4">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-base sm:text-lg font-black text-slate-900 tracking-tight flex items-center gap-2">
                  <ShoppingBag className="size-4.5 text-cyan-600" />
                  <span>Recent Customer Orders</span>
                </h3>
                <p className="text-xs text-slate-400 font-medium">Real-time trade order flow</p>
              </div>

              <Link
                to="/admin/orders"
                className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl bg-slate-50 hover:bg-slate-100 text-slate-700 font-extrabold text-xs border border-slate-200 transition cursor-pointer"
              >
                ...
                displayOrders.slice(0, 5).map((order: any) => (
                  <div key={order._id || order.id} className="py-3.5 flex items-center justify-between gap-4">
                    <div className="flex items-center gap-3">
                      <div className="size-10 rounded-2xl bg-cyan-50 text-cyan-700 font-black text-xs grid place-items-center shadow-2xs">
                      ...
                      <div>
                        ...
                        <div className="text-[11px] text-slate-400 mt-0.5">{order.email || order.id}</div>
                      </div>
                    </div>
          ...
          <div className="bg-white border border-slate-200/90 rounded-3xl p-6 sm:p-7 shadow-2xs space-y-4">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-base sm:text-lg font-black text-slate-900 tracking-tight flex items-center gap-2">
                  <RotateCcw className="size-4.5 text-amber-600" />
                ...
                <p className="text-xs text-slate-400 font-medium">Customer returns, warranty replacements, and refund requests</p>
              </div>

              <Link
                to="/admin/returns"
                className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl bg-amber-50 hover:bg-amber-100 text-amber-900 font-extrabold text-xs border border-amber-200 transition cursor-pointer"
              >
            ...
            <div className="divide-y divide-slate-100">
              {returnsList.length > 0 ? (
                returnsList.slice(0, 5).map((ret: any) => {
                  ...
                  return (
                    <div key={ret.id || ret.rmaId} className="py-3.5 flex items-center justify-between gap-4">
                      <div className="flex items-center gap-3">
                        <div className="size-10 rounded-2xl bg-amber-50 text-amber-700 font-mono font-black text-xs grid place-items-center shadow-2xs">
                          RMA
                        </div>
                        <div>
                          <div className="font-extrabold text-xs sm:text-sm text-slate-900 flex items-center gap-2">
                            <span>{ret.customerName || "Customer"}</span>
                            <span className="text-[10px] font-mono text-slate-400 font-bold">{ret.rmaId}</span>
                            <span className="text-[10px] text-slate-400">· Order #{ret.orderId}</span>
                          </div>
                          <div className="text-[11px] text-slate-500 mt-0.5 flex items-center gap-2">
                            <span className="font-semibold text-slate-700">Reason: {ret.reason}</span>
                            <span>·</span>
          ...
          <div className="bg-white border border-slate-200/90 rounded-3xl p-6 sm:p-7 shadow-2xs space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-slate-400 font-medium">Commercial contractor proposals, custom specs, and equipment quotes</p>
              </div>

              <Link
                to="/admin/quotes"
                className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl bg-blue-50 hover:bg-blue-100 text-blue-900 font-extrabold text-xs border border-blue-200 transition cursor-pointer"
              >
            ...
            <div className="divide-y divide-slate-100">
              {quotesList.length > 0 ? (
                quotesList.slice(0, 5).map((q: any) => {
                  ...
                  return (
                    <div key={q.id || q.quoteId} className="py-3.5 flex items-center justify-between gap-4">
                      <div className="flex items-center gap-3">
                        <div className="size-10 rounded-2xl bg-blue-50 text-blue-700 font-mono font-black text-xs grid place-items-center shadow-2xs">
                          Q
                        </div>
                        <div>
                          <div className="font-extrabold text-xs sm:text-sm text-slate-900 flex items-center gap-2">
                            <span>{q.projectName}</span>
                            <span className="text-[10px] font-mono text-slate-400 font-bold">#{q.quoteId}</span>
                          </div>
                          <div className="text-[11px] text-slate-500 mt-0.5 flex items-center gap-2">
                            <span className="font-semibold text-slate-700">{q.customerName || "Customer"}</span>
                            <span>·</span>
                            <span>Target: {q.targetCompletionDate || "30 Days"}</span>
                          </div>
                        </div>
                      </div>
        ...
        <div className="lg:col-span-4 space-y-6">
          ...
          <div className="bg-gradient-to-br from-[#061220] via-[#091f38] to-[#040d1a] text-white border border-cyan-500/20 rounded-3xl p-6 shadow-md space-y-5">
            <div className="flex items-center justify-between border-b border-white/10 pb-3.5">
              <div>
                <h4 className="text-sm font-black text-white flex items-center gap-2">
                  <Globe className="size-4 text-cyan-400 animate-spin" style={{ animationDuration: "12s" }} />
                  Global Traffic Telemetry
                </h4>
                <p className="text-[10px] text-slate-400 mt-0.5">Live Database Hit Feed</p>
              </div>
            ...
            <div className="space-y-3">
              <div className="p-3.5 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-between">
                <div>
                  ...
                  <div className="text-lg font-black text-cyan-300 mt-0.5">{m.totalPageHits.toLocaleString()}</div>
                </div>
                <div className="text-right">
                  <div className="text-[10px] font-bold text-slate-400 uppercase">Today's Traffic</div>
                  <div className="text-lg font-black text-emerald-400 mt-0.5">+{m.todayHits.toLocaleString()}</div>
                </div>
              </div>
          ...
          <div className="bg-white border border-slate-200/90 rounded-3xl p-6 shadow-2xs space-y-4">
            ...
            <div className="space-y-2.5">
              <Link
                to="/admin/emails"
                className="flex items-center justify-between p-3.5 rounded-2xl bg-slate-50 hover:bg-cyan-50 border border-slate-100 hover:border-cyan-200 transition group cursor-pointer"
              >
                <div className="flex items-center gap-3">
                  <div className="size-9 rounded-xl bg-cyan-600 text-white grid place-items-center">
                    <Mail className="size-4" />
                  </div>
                  <div>
                    <div className="text-xs font-extrabold text-slate-900">Web Form Inquiries</div>
                    <div className="text-[10px] text-slate-400">Trade inquiries & quotes</div>
                  </div>
                </div>
                {m.unreadEmails > 0 ? (
                  ...
                  <ArrowUpRight className="size-4 text-slate-400 group-hover:text-cyan-700 transition" />
                )}
              </Link>
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="size-9 rounded-xl bg-slate-900 text-white grid place-items-center">
                    <MessageCircle className="size-4" />
                  </div>
                  <div>
                    <div className="text-xs font-extrabold text-slate-900">Live Customer Chat</div>
                    <div className="text-[10px] text-slate-400">Real-time trade messaging</div>
                  </div>
                </div>
                {m.activeChats > 0 ? (
              ...
              <Link
                to="/admin/returns"
                className="flex items-center justify-between p-3.5 rounded-2xl bg-amber-50/60 hover:bg-amber-100/70 border border-amber-200/80 transition group cursor-pointer"
              >
                <div className="flex items-center gap-3">
                  <div className="size-9 rounded-xl bg-amber-500 text-white grid place-items-center">
                    <RotateCcw className="size-4" />
                  </div>
                  <div>
                    <div className="text-xs font-extrabold text-slate-900">Returns & Warranty (RMA)</div>
                    <div className="text-[10px] text-slate-500">Resolve claims & dispatch replacements</div>
                  </div>
                </div>
                <ArrowUpRight className="size-4 text-amber-700 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform" />
              </Link>
            </div>
          </div>
        </div>
